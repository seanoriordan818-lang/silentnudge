    ...
    <div className="max-w-[600px] mx-auto text-center">
      <Reveal>
        ...
        <button
          onClick={onAddToCart}
          disabled={isLoading}
          className="w-full md:w-auto md:px-12 py-4 min-h-[56px] rounded-full bg-primary text-primary-foreground font-bold text-base shadow-gold transition-all hover:brightness-110 disabled:opacity-50 mb-4"
        >
          Try It Risk-Free — $99
        </button>
